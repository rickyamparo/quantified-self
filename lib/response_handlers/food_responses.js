...
const appendFood = (response) => {
  response.forEach(function(data){
    $('tbody#food-table').append(`<tr class="food-row${data.id}"><td contenteditable="true" class="name">${data.name}</td> <td contenteditable="true" class="calories">${data.calories}</td> <td align="center"><i class="fa fa-minus-circle" aria-hidden="true"></i></td></tr>`)
  })
}
